...
try:
    ...
    conf = SparkConf().setMaster("local[16]").setAppName("StockSnapshot")\
...
#         .set("spark.network.timeout", "6000s")
    ...
    stock.write.jdbc(url=Sqlurlwrite, table="Stock_raw", mode="overwrite")
    ...
    #         exit()
            ...
            ###############DELETE FROM SQL
            '''
            con= psycopg2.connect(database="kockpit", user="sa", password = "M99@321", \
                              host = "sqlserver://MARKET-NINETY3\MARKET99", port = "5432")
            
            con= pyodbc.connect('Driver={SQL Server};'
                          'Server=MARKET-NINETY3\MARKET99;'
                          'Database=kockpit;'
