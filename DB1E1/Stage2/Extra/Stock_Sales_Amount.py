...
#     exit()
    ...
    table1 = table1.withColumn("Net_Sale_Value",lit(0))
    table1.show()
    print("table1")
    table3 = table1
...
#   exit()
    ...
    Table1 = "(Select Godown_Code,Lot_Code,Item_Det_Code,Vouch_Code,Calc_Net_Amt AS Net_Sale_Value from SL_Txn20192020) as tb"
    ...
    table1.write.jdbc(url=Postgresurl, table="market99"+".NewStock", mode="overwrite", properties=Postgresprop)
    print("Final")
