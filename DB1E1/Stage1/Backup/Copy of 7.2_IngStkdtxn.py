...
try:
    ...
    conf = SparkConf().setMaster("local[16]").setAppName("Stage1:7_DataIngeststk_dtxn").set("spark.serializer", "org.apache.spark.serializer.KryoSerializer")\
    ...
    for j in range(0,df.count()):
        ...
        if tbname1=="stk_dtxn":
            ...
            #### SLHAEDSL_TXN1
            if os.system("hadoop fs -ls /KOCKPIT/DB1E1/Stage1/stk_dtxn23")==256: # 256 Code Defines PARQUET DOES NOT EXIST
                ...
                for FY in range(20172018,int(SQLyear),10001):
                    print(FY)
