...
try:
    ...
    conf = SparkConf().setMaster(smaster).setAppName("Stage1:6_DataIngestRolling").set("spark.serializer", "org.apache.spark.serializer.KryoSerializer")\
                .set('spark.local.dir', path+"/dump")\
                .set("spark.executor.memory","30g")
    sc = SparkContext(conf = conf)
    sqlctx = SQLContext(sc)
    spark = SparkSession.builder.appName("Stage1:6_DataIngestRolling").getOrCreate()
