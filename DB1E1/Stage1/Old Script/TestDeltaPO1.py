...
try:
    ...
    tbname2='Pur_Head'
        ...
        #### SLHAEDSL_TXN1
    #if os.system("hadoop fs -ls /KOCKPIT/DB1E1/Stage1/PohPotPuhPutTest1")==256: # 256 Code Defines PARQUET DOES NOT EXIST
    ...
    for FY in range(20182019,(int(SQLyear)+100),10001):
        if FY == 20182019:
            ...
            #table.show()
            #table.write.format("delta").partitionBy("yearmonth").mode("overwrite").save("/Delta/Stage1/PohPotPuhPutTest1")
            table.write.format("delta").partitionBy("yearmonth").mode("overwrite").save(hdfspath+"/"+DBET+"/Stage1/PohPotPuhPutTest1")
            print("WRITTEN",tbname1)
            #tableAll = tableAll.unionByName(table)
            #tableAll.cache()
    print("SUCCESSFULLY RAN 20182019 FULL YEARS RELOAD")
...
#         prevTab.show()
        ...
        if pastFY==presentFY:
            ...
            tablePM.write.mode(owmode).save(hdfspath+"/"+DBET+"/Stage1/PohPotPuhPutTest1/yearmonth="+pastFY+PM)
            ...
            #table.cache()
            table.write.mode(owmode).save(hdfspath+"/"+DBET+"/Stage1/PohPotPuhPutTest1/yearmonth="+pastFY+CM)
...
#             print(SQLyear)
            ...
            #table.cache()
            table.write.mode(owmode).save(hdfspath+"/"+DBET+"/Stage1/PohPotPuhPutTest1/yearmonth="+presentFY+CM)
